<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
            ...
            <form class="mt-8 space-y-6" @submit.prevent="UpadatepasswordForm">
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        <label for="actual-password" class="sr-only">Mot de passe Actuel</label>
                        <input id="actual-password" name="actual-password" type="password"
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        <label for="newPassword" class="sr-only">Confirmation de mot de passe</label>
                        <input id="newPassword" name="newPassword" type="password" required
                            class="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
